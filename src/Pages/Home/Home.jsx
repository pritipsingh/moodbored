    ...
    <div className="h-full" {...storyblokEditable(blok)}>
      <div className="relative main  h-screen w-screen flex flex-col justify-center items-center  mt-0">
        <div className="flex justify-center items-center ">
          <h1 className="xl:text-[7rem] mb-20  lg:text-[8rem] text-[3rem] z-[99] md:text-[8rem] font-head">
            {blok ? blok.title : "Heyy"}
          </h1>
        </div>
      ...
      <div className="relative mb-[20%] grid grid-cols-1 lg:grid-cols-2  xl:grid-cols-2 md:grid-cols-2  sm:grid-cols-2  ">
        ...
        <div className="relative flex justify-center items-center text-center text-xl mx-12 font-head mt-[45%] md:mt-0 xl:mt-0 lg:mt-0">
          <img
            src={song}
            className="absolute w-[50%] h-[50vh] shadow-lg shadow-yellow-500/30   border border-black rounded-3xl left-[33%] top-[70%]"
          />
          <img
            src={quote}
            className="relative w-[50%] h-[40vh] shadow-lg shadow-yellow-500/30  border border-black rounded-3xl z-[999] left-[5%]"
          />
          <img
            src={sky}
            className="w-[80%] z-[99] h-[30vh] relative right-[5%] shadow-lg shadow-yellow-500/30   border border-black rounded-3xl"
          />
        </div>
      </div>
    </div>
